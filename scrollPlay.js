    ...
    class ScrollPlay {
        ...
        scrollListener(e) {
            ...
            if (scrollPosition >= 0 && scrollPosition <= this.maxHeight) {
                ...
                let opacity = parseFloat(1 - scrollPosition / this.maxHeight).toFixed(2);
                document.getElementById("img_container").style.opacity = opacity;

                if (opacity == 0) {
                    console.log(this.activeImage);
                    window.scrollTo(0, 0);
                    document.getElementById("body-content").style.position = 'initial';
